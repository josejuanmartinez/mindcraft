...
class LocalLLM(LLM):
    def __init__(self,
        ...
        self.model = AutoModelForCausalLM.from_pretrained(model_name.value, device_map=self.device)
        self.tokenizer = AutoTokenizer.from_pretrained(model_name.value, device_map=self.device)
